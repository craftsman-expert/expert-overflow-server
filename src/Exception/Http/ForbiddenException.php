 ...
 * Доступ запрещён и привязан к логике приложения (например, у пользователя не хватает прав доступа к
 * запрашиваемому ресурсу).
 */
class ForbiddenException extends \Exception implements HTTPStatusExceptionInterface
{
